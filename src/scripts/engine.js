...
/* Implementando a lógia de setar cartas em campo */
...
async function setCardsField(cardId) {
  ...
  await howHiddenCardFieldsImages(true);
...
async function updateScore() {
  state.score,
    (scoreBox.innerText = `Win: ${state.score.playerScore} | Lose: ${state.score.computerScore}`);
}

/* Lógica do duelo */
async function checkDuelResults(playerCardId, computerCardId) {
  let duelResults = "Deaw";
...
/* Implementando o removeAllCardImages */
